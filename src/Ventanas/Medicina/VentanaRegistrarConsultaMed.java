...
public class VentanaRegistrarConsultaMed extends JFrame {
    String user;
    ...
    public VentanaRegistrarConsultaMed(){
        user = Login.user;

        setSize(800,400);
        setTitle("Registrar consulta - Sesion de "+user);
        setResizable(false);
        setLayout(null);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);

        ltitulo = new JLabel("Pacientes atendidos");
        ...
        tablaPacientes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event){
                ...
                if (fila_point >-1){
                    ...
                    new VentanaImprimirEpicrisis().setVisible(true);
                }
            }
        });
