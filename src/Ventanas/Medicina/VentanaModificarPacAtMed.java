...
public class VentanaModificarPacAtMed extends JFrame {
    String user;
    ...
    String estatus = "Atendido";


    public VentanaModificarPacAtMed(){
        user = Login.user;
        ...
        ltitulo = new JLabel("Modificar paciente");
        ...
        tablaPacientes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event){
                ...
                if (fila_point >-1){
                    ...
                    new VentanaModificarAtributosPacMed().setVisible(true);
                }
            }
        });
