...
import Logs.Log;
import Ventanas.Administrativo.VentanaModificarAtributosPaciente;
import Ventanas.Login;
import org.apache.log4j.Logger;

public class VentanaModificarPacientes extends JFrame {
    String user;
    ...
    private static final Logger LOG = Log.getLogger(VentanaModificarPacientes.class);

    public VentanaModificarPacientes(){
        LOG.debug("DEBUG:: ventana modificar paciente");

        user = Login.user;

        setSize(800,400);
        setTitle("Modificar paciente - Sesion de "+user);
        setResizable(false);
        setLayout(null);
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("" +
                    "select hc, nombre_paciente, dni_paciente from pacientes");
            ...
            LOG.debug("ERROR:: Error al llenar tabla");
        ...
        tablaPacientes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event){
                ...
                if (fila_point >-1){
                    ...
                    new VentanaModificarAtributosPaciente().setVisible(true);
                }
            }
        });
